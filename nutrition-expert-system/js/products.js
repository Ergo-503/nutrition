...
const PRODUCTS_DATABASE = [
    ...
    {name: "Капуста білокачанна", protein: 1.8, fat: 0.1, carbs: 4.7, calories: 25, cost: 0.3, vegan: true, gi: 15},
    {name: "Огірки свіжі", protein: 0.8, fat: 0.1, carbs: 2.5, calories: 14, cost: 0.6, vegan: true, gi: 15},
    {name: "Помідори", protein: 1.1, fat: 0.2, carbs: 3.7, calories: 20, cost: 0.8, vegan: true, gi: 30}
];
